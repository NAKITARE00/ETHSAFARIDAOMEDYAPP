...
const {  PINATA_API_SECRET } = process.env;
    ...
    <div className="w-[60%] h-[100%] flex justify-center items-center mx-auto flex-col gap-2">
      <section className="flex w-[100%] text-white gap-2 h-[70%]">
        <div
          ...
          className="cursor-pointer w-[50%] bg-white p-2 flex justify-center items-center shadow-2xl rounded-lg flex-col gap-5"
        >
        ...
        <div className="w-[50%] bg-white p-2 rounded-lg shadow-2xl">
          {File && (
      ...
      <section className="w-[100%] bg-blue-500 text-white text-bold  rounded-lg">
